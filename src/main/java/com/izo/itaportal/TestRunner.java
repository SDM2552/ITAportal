...
public class TestRunner implements ApplicationRunner{
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            // 설정된 AUTO_INCREMENT 값을 2024001로 변경
            ...
            sqlStatements.add("INSERT INTO exam(name, start_date, end_date, status, count, description, id_program, id_prof) VALUES ('자유무역협정 시험', '2024-05-10', '2024-05-24', '진행중', '5', '수업 시간에 배운걸 다 써서 내세요.','2','1')");
