            ...
            <button onclick="scheduleInput()">주차별 강의계획 입력</button>
                <!-- 강의 정보 입력 폼 -->
                    ...
                    <div class="classForm tblData mt10" id="classForm">
                        ...
                        <div>
                            <label for="courseOverview">교과목 개요:<i id="counter">0/300자</i></label>
                            <textarea id="courseOverview" rows="5" placeholder="강의 개요 입력" onkeyup="countingLength(this);" >${syllabus.courseOverview}</textarea>
                        </div>
                        <div>
